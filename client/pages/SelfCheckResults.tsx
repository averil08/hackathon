...
Ginhaw.AI Self-Check Assessment Report
=====================================
            ...
            {content.showProviders && (
              <div className="mt-12 mb-8 text-center">
                <button
                  ...
                  className="inline-flex items-center gap-3 px-8 py-4 bg-ginhaw-blue-500 text-white rounded-lg hover:bg-ginhaw-blue-600 transition-colors text-lg font-semibold"
                >
